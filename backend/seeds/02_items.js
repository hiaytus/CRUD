...
exports.seed = async function(knex) {
  ...
  await knex('items').insert([
    ...
    {item_id: 3, item: 'books', description: "turi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi turi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitiaanimi", quantity: 5, uid: "mIcbqbVKWJZXSaplPiFBuqeHC5M2"},
